...
I used the Manhattan norm with Cosine distance.
...
Reinforcing the result seen in the chromagrams. This SSM shows that *White Horses* is relatively harmonically stable. 

There is also a clear block pattern, which indicates a reptetive structure in the song. This is the verse and chorus structure that is seen, where the yellow lines indicate the prechorus and chorus together. 

### Column

![](carousel_cssm.png)

*Carousel* on the other hand, is not as harmonically stable. The pattern in more complex and harder to interpret. However, we can still faintly see some criss-cross patterns around 50 seconds and 110 seconds. These correspond to the chorus. 

### Column

![](glass_cssm.png)
*Broken Glass* is also harder to interpret, as it harmonically dynamic. We can see a few clear sections, such as in the top right, we can see the part where there is the instrumental break at the end.

Around 40 seconds she starts singing in a higher pitch as well, where we can see a yellow cross line. 
